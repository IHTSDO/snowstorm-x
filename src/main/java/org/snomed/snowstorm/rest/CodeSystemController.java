...
public class CodeSystemController {
	...
	@Operation(summary = "Create a code system",
			description = """
					Required fields are **shortName** and **branchPath**.
					- **shortName** should use format SNOMEDCT for the root Edition or SNOMEDCT-XX where XX is the country code for national extensions.
					- **branchPath** should be "MAIN" for the root Edition, or use format MAIN/SNOMEDCT-XX using the shortName.
