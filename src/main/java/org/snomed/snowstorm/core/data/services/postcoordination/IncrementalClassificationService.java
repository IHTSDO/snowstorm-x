...
public class IncrementalClassificationService {
	...
	private RelationshipChangeProcessor classify(Set<AxiomRepresentation> axioms, String branch) throws ReasonerServiceException {
		final ClassificationContainer classificationContainer = setupContainer(branch);
		return snomedReasonerService.classifyTransientAxioms(axioms, true, classificationContainer);
	}
