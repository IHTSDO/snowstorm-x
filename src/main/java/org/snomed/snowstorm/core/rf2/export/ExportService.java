...
public class ExportService {
	...
	private void exportRefset(String branchPath, String filenameEffectiveDate, RF2Type exportType, String transientEffectiveTime,
			...
			ZipOutputStream zipOutputStream, String codeSystemRF2Name, ReferenceSetTypeExportConfiguration referenceSetType, Long refsetToExport, Query memberBranchCriteria,
